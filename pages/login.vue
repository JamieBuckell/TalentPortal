<template>
  <div>
    ...
    <main>
      ...
      <section class="pb-10 pt-10 bg-gray-300">
        <div class="container mx-auto px-4">
          <div class="flex flex-wrap">
            <div class="w-full lg:w-12/12 px-10 text-center">
              <p v-if="hasError" class="text-red-500 font-semibold text-s pb-10 login-error">{{ errorMessage }}</p>
              <p v-if="!hasError" class="text-red-500 font-semibold text-s pb-10 login-error">&nbsp;</p>
            </div>
