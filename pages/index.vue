<template>
  <div>
    ...
    <main>
            ...
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">No Third-party Interference</h6>
            ...
            <div class="w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Proven Experience</h6>
                  <p class="mt-2 mb-4 text-gray-600">
            ...
            <div class="pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">There for you</h6>
                  <p class="mt-2 mb-4 text-gray-600">
                    Our Account Team is in place to ensure the very best service is always delivered; they continually look at ways we can improve improve improve. 
                  </p>
                </div>
              </div>
            </div>
      ...
      <section class="relative h-50 p-8" style="background: rgb(102,181,150); background: linear-gradient(180deg, rgba(102,181,150,1) 0%, rgba(141,199,211,1) 100%)">
        <div
          ...
          <div class="flex flex-wrap text-center justify-center">
            <div class="w-full lg:w-6/12 px-4">
              ...
              <p class="text-lg leading-relaxed mt-4 mb-4 text-gray-500">
                Found what you're looking for? Want more information? Can't find what you need?<br />
